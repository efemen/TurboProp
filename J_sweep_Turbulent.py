...
from active_grid_tools import active_grid  
...
print("Bias file: ", pre_bias_file)
bias_data = io.loadmat(pre_bias_file)
...
description = "Propeller " + prop_name + " J sweep from " + str(J_min) + " to " +  str(J_max) + " "+ str(duration) + " seconds with turbulence."
...
# WT.set_fan_speed(15.5) # Case 0, Turbulent 8 m/s

# WT.set_fan_speed(15.8) # Case 1, Turbulent 6 m/s
# WT.set_fan_speed(22.5) # Case 1, Turbulent 8 m/s

# WT.set_fan_speed(15.5) # Case 2, Turbulent 6 m/s
# WT.set_fan_speed(22.7) # Case 2, Turbulent 8 m/s
...
bias_mean_post = bias_data_post["mean_force"]
